...
from Akshi import BOTLOG, BOTLOG, CMD_HELP, bot
...
async def spider(spdr):
    ...
    try:
        from Akshi.sql.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from Akshi.sql.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        from Akshi.sql.gmute_sql import is_gmuted
        from Akshi.sql.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    """ For ?ungmute command, ungmutes the target in the Akshi """
    # Admin or creator check
    ...
    # Check if the function running under SQL mode
    try:
        from Akshi.sql.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    # Check if the function running under SQL mode
    try:
        from Akshi.sql.gmute_sql import gmute
    except AttributeError:
